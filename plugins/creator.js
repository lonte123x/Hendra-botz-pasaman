...
let name = await conn.getName(who)
 ...
 const ini = await conn.sendContactArray(m.chat, [
    [`${nomorown}`, `${await conn.getName(nomorown+'@s.whatsapp.net')}`, `👑 Developer Bot `, `🚫 Don't call me 🥺`, `⁨hendralubeck307@gmail.com`, `🇮🇩 Indonesia`, `🚀 https://www.instagram.com/p/CH2cKXnHV3i/?igshid=YmMyMTA2M2Y=`, `nothing`],
    [`${conn.user.jid.split('@')[0]}`, `${await conn.getName(conn.user.jid)}`, `🔥 Bot WhatsApp 🐣`, `📵 Don't spam/call me 😢`, `Nothing`, `🇮🇩 Indonesia`, `🚀 https://www.instagram.com/p/CH2cKXnHV3i/?igshid=YmMyMTA2M2Y=`, `🤖 Dont Forget To Donate!`]
  ], fkontak)
